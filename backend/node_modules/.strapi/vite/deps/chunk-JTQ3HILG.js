...
import {
  LimitsModal,
  useReviewWorkflows
} from "./chunk-KJOL3GCC.js";
import {
  AssigneeColumn,
  StageColumn,
  getDisplayName
} from "./chunk-3JPPTCBJ.js";
import {
  getStageColorByHex
} from "./chunk-LPNABGS5.js";
import {
...
} from "./chunk-H5ULAKGY.js";
import {
  useTypedSelector
} from "./chunk-KGMXTQBV.js";
import {
  ReleaseActionMenu,
  ReleaseActionOptions
} from "./chunk-MRTYMOEO.js";
import {
  index
} from "./chunk-UAR6JRJI.js";
import {
...
import {
  ...
  usePersistentState,
  useSelectionState
} from "./chunk-PYNNBV5B.js";
import {
  useConfig
} from "./chunk-2VKDR4PJ.js";
import {
  Drawer,
  abortUpload,
  cancelUpload,
...
import {
  useDocumentActions
} from "./chunk-LJZE2HYY.js";
import {
  buildValidParams,
  useContentManagerContext,
  useDocument,
  useDocumentLayout
} from "./chunk-IJBDOE5L.js";
import {
  PERMISSIONS,
  reducer,
  reducer2
} from "./chunk-DF55UPOF.js";
import {
  pluginId
...
import {
  useAdminUsers
} from "./chunk-ACPLVRE4.js";
import {
  useAIAvailability
} from "./chunk-TZHM3KHX.js";
import {
  useLicenseLimits
} from "./chunk-WL4CBFPG.js";
import {
  create3 as create,
  create4 as create2,
  create6 as create3,
...
// node_modules/@strapi/strapi/node_modules/lodash/union.js
var require_union = __commonJS({
  "node_modules/@strapi/strapi/node_modules/lodash/union.js"(exports, module) {
...
var index2 = {
  register(app) {
    ...
    app.addMenuLink({
      ...
      Component: () => import("./App-H22GAYPX.js"),
      position: 5
    });
    app.registerPlugin({
      id: pluginId,
...
var admin = {
  ...
  register(app) {
    app.addSettingsLink({
      ...
      id: "settings",
      to: "email",
      Component: () => import("./Settings-COVNJNCH.js").then((mod) => ({
...
var admin2 = {
  register(app) {
    app.addMenuLink({
      ...
      Component: () => {
        return import("./App-HPYIXPWZ.js").then((mod) => ({
          default: mod.Upload
        }));
      },
      position: 4
    ...
    if (window.strapi.future.isEnabled("unstableMediaLibrary")) {
      ...
      app.addMenuLink({
        ...
        permissions: PERMISSIONS3.main,
        Component: () => {
          return import("./App-DEZX3B44.js").then((mod) => ({
    ...
    app.addSettingsLink("global", {
      ...
      Component() {
        return import("./SettingsPage-J2B3DUNR.js").then((mod) => ({
          default: mod.ProtectedSettingsPage
        }));
      },
...
var index3 = {
  ...
  bootstrap(app) {
    ...
    app.addSettingsLink("global", {
      ...
      Component: () => import("./SettingsPage-D4DI7TF5.js").then((mod) => ({
        default: mod.ProtectedSettingsPage
      })),
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled("cms-content-releases")) {
      app.addMenuLink({
        ...
        Component: () => import("./App-ZIKHYNAM.js").then((mod) => ({
          default: mod.App
        })),
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        Component() {
          return import("./ReleasesSettingsPage-LPDS5PWK.js").then((mod) => ({
      ...
      app.widgets.register([
        {
          ...
          component: async () => {
            const { UpcomingReleasesWidget } = await import("./Widgets-DTO7TUMZ.js");
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        Component() {
          return import("./PurchaseContentReleases-IUJUL2DM.js").then((mod) => ({
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled(FEATURE_ID)) {
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        Component() {
          return import("./router-QKDON65A.js").then((mod) => ({
            default: mod.Router
          }));
        }
      });
      app.widgets.register((widgets) => [
        ...widgets,
        {
          ...
          component: async () => {
            const { AssignedWidget } = await import("./Widgets-3YRR52HF.js");
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        Component() {
          return import("./purchase-review-workflows-IOTQCB4I.js").then((mod) => ({
...
//# sourceMappingURL=chunk-JTQ3HILG.js.map
