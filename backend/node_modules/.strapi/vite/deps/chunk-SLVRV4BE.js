import {
  ...
  HOOKS
} from "./chunk-FL57ROUY.js";
import {
  useNpsSurveySettings
} from "./chunk-YJN4GQBO.js";
import {
  require_pick
} from "./chunk-ALPKVVYT.js";
import {
  getBasename
...
import {
  ...
  getEERoutes
} from "./chunk-GFL35LFF.js";
import {
  Login
} from "./chunk-7XTY34LB.js";
import {
  MemoizedInputRenderer
} from "./chunk-OZ3XXDTS.js";
import {
  Form
} from "./chunk-Y2RLP447.js";
import {
  Column,
  LayoutContent,
  Logo,
  UnauthenticatedLayout
} from "./chunk-LPQ35ONP.js";
import {
  ConfigurationProvider
} from "./chunk-XLQ7CURE.js";
import {
  require_baseMerge,
  require_createAssigner,
  require_merge,
  require_omit
} from "./chunk-2HXJ3PXU.js";
import {
  require_baseRest
} from "./chunk-2VWEBTWG.js";
import {
  HistoryProvider
} from "./chunk-Z2L4SAJD.js";
import {
  useClipboard
} from "./chunk-TD7TG5DG.js";
import {
  GuidedTourContext,
  useAIAvailability
} from "./chunk-TZHM3KHX.js";
import {
  useGetAiUsageQuery
} from "./chunk-5CZB52TL.js";
import {
  _setPrototypeOf
} from "./chunk-MBK4V2X7.js";
import {
  useEnterprise
} from "./chunk-EETW7QD4.js";
import {
  Layouts
} from "./chunk-OK3K5VRD.js";
import {
  errorsTrads
...
import {
  ...
  TrackingProvider,
  useTracking
} from "./chunk-OU5RAIEV.js";
import {
  require_isEqual
} from "./chunk-E4AHZTES.js";
import {
  createAbsoluteUrl,
  useInitQuery
} from "./chunk-VBUBDATT.js";
import {
  Page,
  l1,
  useAPIErrorHandler
} from "./chunk-FNVCK74I.js";
import {
  AuthProvider,
  StrapiAppProvider,
  getOrCreateDeviceId,
  ...
  useTypedSelector,
  useTypedStore
} from "./chunk-N4XFGGVA.js";
import {
  NotificationsProvider,
  useNotification
} from "./chunk-Q3KUFZFX.js";
import {
...
// node_modules/@strapi/strapi/node_modules/lodash/_arrayIncludesWith.js
var require_arrayIncludesWith = __commonJS({
  "node_modules/@strapi/strapi/node_modules/lodash/_arrayIncludesWith.js"(exports, module2) {
...
// node_modules/@strapi/strapi/node_modules/lodash/_createSet.js
var require_createSet = __commonJS({
  "node_modules/@strapi/strapi/node_modules/lodash/_createSet.js"(exports, module2) {
...
// node_modules/@strapi/strapi/node_modules/lodash/_baseUniq.js
var require_baseUniq = __commonJS({
  "node_modules/@strapi/strapi/node_modules/lodash/_baseUniq.js"(exports, module2) {
...
// node_modules/@strapi/strapi/node_modules/lodash/uniq.js
var require_uniq = __commonJS({
  "node_modules/@strapi/strapi/node_modules/lodash/uniq.js"(exports, module2) {
  ...
  ...window.strapi.features.isEnabled(window.strapi.features.AUDIT_LOGS) ? [
    {
      path: "audit-logs",
      lazy: async () => {
        const { ProtectedListPage } = await import("./ListPage-3L3FKQJR.js");
        return {
  ...
  ...window.strapi.features.isEnabled(window.strapi.features.SSO) ? [
    {
      path: "single-sign-on",
      lazy: async () => {
        const { ProtectedSSO } = await import("./SingleSignOnPage-VZ4UHTI5.js");
        return {
...
var AuthPage = () => {
  ...
  const { hasAdmin } = data ?? {};
  const Login$1 = useEnterprise(Login, async () => (await import("./Login-4ICDRQZ7.js")).LoginEE);
  const forms = useEnterprise(FORMS, async () => (await import("./constants-Q7QHQ6SR.js")).FORMS, {
...
var ADMIN_TOKEN_ROUTES = [
  {
    lazy: async () => {
      const { ProtectedListView } = await import("./ListView-MUFHDKOJ.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedCreateView } = await import("./CreateView-6WIK3B4L.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedEditView } = await import("./EditViewPage-XEOKAEXL.js");
      return {
...
var ROUTES_CE = () => [
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-P7YGBB2M.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreatePage } = await import("./CreatePage-OX65GSTR.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await import("./EditPage-7XQFROVS.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-FPRQ6JEK.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await import("./EditPage-XWJUTN4T.js");
      return {
        Component: ProtectedEditPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreatePage } = await import("./CreatePage-NNIHQT5R.js");
      return {
        Component: ProtectedCreatePage
      };
    },
  ...
  {
    lazy: async () => {
      const editWebhook = await import("./EditPage-UF3BXSXN.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-QWGAKFCY.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedListView } = await import("./ListView-HAB55K7N.js");
      return {
        Component: ProtectedListView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreateView } = await import("./CreateView-KHFTKHWN.js");
      return {
        Component: ProtectedCreateView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditView } = await import("./EditViewPage-JAZP3IDG.js");
      return {
        Component: ProtectedEditView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreateView } = await import("./CreateView-ODH23HZS.js");
      return {
        Component: ProtectedCreateView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedListView } = await import("./ListView-54VN5R6W.js");
      return {
        Component: ProtectedListView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditView } = await import("./EditView-VFMEDDJF.js");
      return {
        Component: ProtectedEditView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedInstalledPlugins } = await import("./InstalledPlugins-MLIRBIN6.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseAuditLogs } = await import("./PurchaseAuditLogs-SETAYNUB.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseSingleSignOn } = await import("./PurchaseSingleSignOn-OUMGCOZH.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseContentHistory } = await import("./PurchaseContentHistory-IWFKHSMW.js");
      return {
...
var getImmutableRoutes = () => [
  {
    path: "usecase",
    lazy: async () => {
      const { PrivateUseCasePage } = await import("./UseCasePage-5JTT46FD.js");
      return {
...
var getInitialRoutes = () => [
  {
    index: true,
    lazy: async () => {
      const { HomePage } = await import("./HomePage-H5J4VD6U.js");
      return {
        Component: HomePage
      };
    }
  },
  {
    path: "me",
    lazy: async () => {
      const { ProfilePage } = await import("./ProfilePage-5U63EHBZ.js");
      return {
  ...
  },
  {
    path: "settings/*",
    lazy: async () => {
      const { Layout } = await import("./Layout-AMAEVT3J.js");
      return {
        Component: Layout
      };
    },
    children: [
      {
        ...
        lazy: async () => {
          const { ApplicationInfoPage } = await import("./ApplicationInfoPage-4L2SW2KA.js");
          return {
    ...
    const routes = [
      {
        ...
        children: [
          ...getImmutableRoutes(),
          {
            path: "/*",
            lazy: async () => {
              const { PrivateAdminLayout } = await import("./AuthenticatedLayout-TZGC4MFB.js");
              return {
    ...
    this.widgets.register([
      {
        ...
        component: async () => {
          const { ProfileWidget } = await import("./Widgets-325HB7MN.js");
      ...
      },
      {
        ...
        component: async () => {
          const { KeyStatisticsWidget } = await import("./Widgets-325HB7MN.js");
      ...
      },
      {
        ...
        component: async () => {
          const { DeployNowWidget } = await import("./Widgets-325HB7MN.js");
      ...
      this.widgets.register([
        {
          ...
          component: async () => {
            const { AuditLogsWidget } = await import("./Widgets-JBS3HHCU.js");
...
//# sourceMappingURL=chunk-SLVRV4BE.js.map
