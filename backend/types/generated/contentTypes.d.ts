...
export interface ApiFooterFooter extends Struct.SingleTypeSchema {
  ...
  attributes: {
    affiliate_disclosure: Schema.Attribute.String;
    copyright_text: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    disclaimer: Schema.Attribute.String;
    footer_columns: Schema.Attribute.Component<'shared.link-item', true>;
...
export interface ApiHeaderHeader extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    nav_links: Schema.Attribute.Component<'shared.link-item', true>;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiLetsHikeLetsHike extends Struct.SingleTypeSchema {
  collectionName: 'lets_hikes';
  info: {
    displayName: 'lets_hike';
    pluralName: 'lets-hikes';
    singularName: 'lets-hike';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiTrailTrail extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    >;
    distance_km: Schema.Attribute.Integer;
    district_end: Schema.Attribute.Relation<
      'oneToOne',
      'api::district.district'
    >;
    district_start: Schema.Attribute.Relation<
      'oneToOne',
      'api::district.district'
    >;
    duration_hours: Schema.Attribute.Decimal;
    elevation_gain_m: Schema.Attribute.Integer;
    ending_point: Schema.Attribute.String;
    gps_coordinates_end: Schema.Attribute.String;
    gps_coordinates_start: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::trail.trail'> &
      Schema.Attribute.Private;
    max_altitude: Schema.Attribute.Decimal;
    permit_required: Schema.Attribute.Boolean;
    ...
    tehsil_end: Schema.Attribute.Relation<'oneToOne', 'api::tehsil.tehsil'>;
    tehsil_start: Schema.Attribute.Relation<'oneToOne', 'api::tehsil.tehsil'>;
    title: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    trail_type: Schema.Attribute.Enumeration<
      ['loop', 'in and out', 'point to point']
    >;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    water_sources: Schema.Attribute.Boolean;
  };
}
